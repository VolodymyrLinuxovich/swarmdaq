    ...
    <div className="min-h-screen bg-black font-mono">
        ...
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-xs text-green-700">live · 3s refresh</span>
            </motion.div>
            {updatedAt && (
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="border border-slate-900 rounded overflow-hidden">
          <div className="grid grid-cols-[2rem_1fr_5rem_5rem_5rem_5rem_4rem_4rem_4rem] gap-0 border-b border-slate-800 px-3 py-2 text-xs text-slate-600 uppercase tracking-wider">
            <span>#</span>
            <span>Agent</span>
            ...
            {entries.map((e, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="grid grid-cols-[2rem_1fr_5rem_5rem_5rem_5rem_4rem_4rem_4rem] gap-0 px-3 py-2.5 border-b border-slate-900 last:border-0 hover:bg-slate-950/60 transition-colors"
                >
